<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.keshifengmian" label="科室封面" prop="keshifengmian">
          <file-upload
          tip="点击上传科室封面"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.keshifengmian" label="科室封面" prop="keshifengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.keshifengmian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="科室成员" prop="keshichengyuan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="科室成员"
                  v-model="ruleForm.keshichengyuan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.keshichengyuan" label="科室成员" prop="keshichengyuan">
                    <span>{{ruleForm.keshichengyuan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.keshifengmian = true;
          ...
          if(o=='keshichengyuan'){
            this.ruleForm.keshichengyuan = obj[o];
	    this.ro.keshichengyuan = true;
            continue;
          }
        }
      }
