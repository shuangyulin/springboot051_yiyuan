<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="病床类型" prop="bingchuangleixing">
          <el-input v-model="ruleForm.bingchuangleixing" 
              placeholder="病床类型" clearable  :readonly="ro.bingchuangleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="病床类型" prop="bingchuangleixing">
              <el-input v-model="ruleForm.bingchuangleixing" 
                placeholder="病床类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.suoshukeshi = true;
          ...
          if(o=='bingchuangleixing'){
            this.ruleForm.bingchuangleixing = obj[o];
	    this.ro.bingchuangleixing = true;
            continue;
          }
          if(o=='tupian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.shiyongzhuangtaiOptions = "空闲,已使用".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
