<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="病人编号" prop="bingrenbianhao">
          <el-input v-model="ruleForm.bingrenbianhao" 
              placeholder="病人编号" clearable  :readonly="ro.bingrenbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="病人编号" prop="bingrenbianhao">
              <el-input v-model="ruleForm.bingrenbianhao" 
                placeholder="病人编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="病床号" prop="bingchuanghao">
          <el-input v-model="ruleForm.bingchuanghao" 
              placeholder="病床号" clearable  :readonly="ro.bingchuanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="病床号" prop="bingchuanghao">
              <el-input v-model="ruleForm.bingchuanghao" 
                placeholder="病床号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="病症" prop="bingzheng">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="病症"
                  v-model="ruleForm.bingzheng" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.bingzheng" label="病症" prop="bingzheng">
                    <span>{{ruleForm.bingzheng}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='bingrenbianhao'){
            this.ruleForm.bingrenbianhao = obj[o];
	    this.ro.bingrenbianhao = true;
            continue;
          }
	    ...
	    this.ro.bingshi = true;
          ...
          if(o=='bingzheng'){
            this.ruleForm.bingzheng = obj[o];
	    this.ro.bingzheng = true;
            continue;
          }
          if(o=='bingchuanghao'){
            this.ruleForm.bingchuanghao = obj[o];
	    this.ro.bingchuanghao = true;
            continue;
          }
          if(o=='ruyuanshijian'){
